    ...
    while episode < TOTAL_EPISODES:
        ...
        with tf.GradientTape() as tape:
            while True:
                ...
                current_x, reward, done, _ = env.step(action.numpy()[0] + 1)
            ...
            J_theta = compute_J_theta(w1, w2, rewards, actions, logits, GAMMA,
                                      TOTAL_ACTIONS, LAMBD)
        ...
        if not (episode + 1) % BATCH_SAVE and print_flag:
            ...
            print(f'This is total plays: {rewards.shape[0]}')
